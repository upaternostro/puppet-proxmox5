...
#        $kernel_pkg_name            = [ 'pve-kernel-4.13.13-6-pve' ]
        $kernel_pkg_name            = [ 'pve-kernel-4.13' ]
        ...
        $pveproxy_default_content   = 'proxmox5/hypervisor/pveproxy_default.erb'
        ...
        $pve_modules_file_content   = 'proxmox5/hypervisor/proxmox_modules.conf.erb'

        # Boot
        $pve_lvm_delay              = true
        $init_lvm_script_path       = '/etc/initramfs-tools/scripts/local-top/lvm-manual'
        $init_lvm_script_content    = 'proxmox5/hypervisor/initramfs-lvm-manual.erb'

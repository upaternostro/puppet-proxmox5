# == Define: proxmox5::hypervisor::user
#
...
#
define proxmox5::hypervisor::user ( $user = $title, $group = '', $permission_file = '/etc/pve/user.cfg' ) {
...
} # Public ressource: proxmox5::hypervisor::user

...
class proxmox5::hypervisor::preconfig {
  ...
  file { '/etc/apt/sources.list.d/pve-enterprise.list':
    ensure => $proxmox5::hypervisor::pve_enterprise_repo_ensure,
  ...
  apt::source {'proxmox5':
    ...
    key         => { 'id'      => '359E95965E2C3D643159CD300D9A1950E2EF0603',
                     ...
                     'options' => "$proxmox5::hypervisor::key_options",
                   },
  }
  ...
  file { $proxmox5::hypervisor::pve_modules_file_path:
    ensure  => present,
    content => template($proxmox5::hypervisor::pve_modules_file_content),
    require => File['/etc/modules-load.d'],
  }

  # Add a delay at boot to allow a good LVM detection
  if $proxmox5::hypervisor::pve_lvm_delay == true {
    file { $proxmox5::params::init_lvm_script_path:
      ensure  => present,
      mode    => '0755',
      content => template($proxmox5::hypervisor::init_lvm_script_content),
...
} # Private class: proxmox5::hypervisor::preconfig
